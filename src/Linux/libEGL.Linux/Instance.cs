...
namespace EGL
{
    public static class Instance
    {
        ...
        public static EGLSurface eglCreatePbufferSurface(EGLDisplay display, EGLConfig config, ref EGLint attrib_list)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static EGLSurface eglCreatePixmapSurface(EGLDisplay display, EGLConfig config, EGLNativePixmapType pixmap, ref EGLint attrib_list)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static EGLSurface eglCreateWindowSurface(EGLDisplay display, EGLConfig config, EGLNativeWindowType win, ref EGLint attrib_list)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglGetConfigAttrib(EGLDisplay display, EGLConfig config, EGLint attribute, ref EGLint value)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglGetConfigs(EGLDisplay display, ref EGLConfig[] configs, EGLint config_size, ref EGLint num_config)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglQueryContext(EGLDisplay display, EGLContext ctx, EGLint attribute, ref EGLint value)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglQuerySurface(EGLDisplay display, EGLSurface surface, EGLint attribute, ref EGLint value)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglBindTexImage(EGLDisplay display, EGLSurface surface, EGLint buffer)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglReleaseTexImage(EGLDisplay display, EGLSurface surface, EGLint buffer)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglSurfaceAttrib(EGLDisplay display, EGLSurface surface, EGLint attribute, EGLint value)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static bool eglGetSyncAttrib(EGLDisplay display, EGLSync sync, EGLint attribute, EGLAttrib[] value)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static EGLSurface eglCreatePlatformWindowSurface(EGLDisplay display, EGLConfig config, IntPtr native_window, EGLAttrib[] attrib_list)
        {
            EnsureEGLLoaded();
            return default;
        }
        ...
        public static EGLSurface eglCreatePlatformPixmapSurface(EGLDisplay display, EGLConfig config, IntPtr native_pixmap, EGLAttrib[] attrib_list)
        {
            EnsureEGLLoaded();
            return default;
        }
